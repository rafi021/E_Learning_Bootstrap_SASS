...
},{"bootstrap":"h36JB","smooth-scrollbar":"7azJf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h36JB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7azJf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
 ...
 */ var SmoothScrollbar = /** @class */ function(_super) {
    (0, _tslib.__extends)(SmoothScrollbar1, _super);
    ...
    SmoothScrollbar1.ScrollbarPlugin = (0, _plugin.ScrollbarPlugin);
...
var Scrollbar = /** @class */ function() {
    ...
    Scrollbar1.prototype._shouldPropagateMomentum = function(deltaX, deltaY) {
        ...
        var destX = (0, _clampDefault.default)(deltaX + offset.x, 0, limit.x);
        var destY = (0, _clampDefault.default)(deltaY + offset.y, 0, limit.y);
        var res = true;
 ...
 */ function clamp(number, lower, upper) {
    ...
    return (0, _baseClampJsDefault.default)((0, _toNumberJsDefault.default)(number), lower, upper);
}
        ...
        Object.defineProperty(proto, key, {
            ...
            set: function(val) {
                Object.defineProperty(this, alias, {
                    value: (0, _clampDefault.default)(val, min, max),
                    enumerable: false,
                    writable: true,
                    configurable: true
                });
        ...
        return {
            get: function() {
                if (!this.hasOwnProperty(key)) Object.defineProperty(this, key, {
                    value: (0, _debounceDefault.default).apply(void 0, (0, _tslib.__spreadArrays)([
                        fn
                    ], options))
                });
                return this[key];
...
function setPosition(scrollbar, x, y) {
    ...
    x = (0, _clampDefault.default)(x, 0, limit.x);
    y = (0, _clampDefault.default)(y, 0, limit.y);
...
function scrollTo(scrollbar, x, y, duration, _a) {
    ...
    var startX = offset.x;
    var startY = offset.y;
    var disX = (0, _clampDefault.default)(x, 0, limit.x) - startX;
    var disY = (0, _clampDefault.default)(y, 0, limit.y) - startY;
    var start = Date.now();
    function scroll() {
...
function scrollIntoView(scrollbar, elem, _a) {
    ...
    scrollbar.setMomentum(targetBounding.left - bounding.left - offsetLeft, (0, _clampDefault.default)(delta, -offset.y, limit.y - offset.y));
}
...
function mouseHandler(scrollbar) {
    ...
    function calcMomentum(direction, clickPosition) {
        ...
        if (direction === Direction.X) {
            ...
            return (0, _clampDefault.default)(clickPosition / totalWidth * size.content.width, 0, limit.x) - offset.x;
        }
        if (direction === Direction.Y) {
            var totalHeight = size.container.height + (yAxis.thumb.realSize - yAxis.thumb.displaySize);
            return (0, _clampDefault.default)(clickPosition / totalHeight * size.content.height, 0, limit.y) - offset.y;
        }
        return 0;
    }
...
function resizeHandler(scrollbar) {
    var addEvent = (0, _.eventScope)(scrollbar);
    addEvent(window, "resize", (0, _debounceDefault.default)(scrollbar.update.bind(scrollbar), 300));
}
...
function selectHandler(scrollbar) {
    ...
    function scroll(_a) {
        ...
        scrollbar.setMomentum((0, _clampDefault.default)(offset.x + x, 0, limit.x) - offset.x, (0, _clampDefault.default)(offset.y + y, 0, limit.y) - offset.y);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequiree79e")
